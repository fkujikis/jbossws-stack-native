...
public class HeaderProxyTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(HeaderProxyTestCase.class, "jbossws-samples-handler.war");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (endpoint == null)
      {
         File javaWsdlMappingFile = new File("resources/samples/handler/WEB-INF/jaxrpc-mapping.xml");
