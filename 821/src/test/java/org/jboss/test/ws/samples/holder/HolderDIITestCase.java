...
{
   private final String TARGET_ENDPOINT_ADDRESS = "http://" + getServerHost() + ":8080/jbossws-samples-holder";
   private static final String TARGET_NAMESPACE = "http://org.jboss.ws/samples/holder";

   public static Test suite()
   {
      return JBossWSTestSetup.newTestSetup(HolderDIITestCase.class, "jbossws-samples-holder.war");
   }
