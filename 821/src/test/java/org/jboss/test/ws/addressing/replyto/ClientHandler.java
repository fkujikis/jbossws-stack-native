...
public class ClientHandler extends AddressingHandler
{
   ...
   public boolean handleRequest(MessageContext msgContext)
   {
      ...
      try
      {
         ...
         outProps.setTo(builder.newURI("uri:jbossws-addressing-initial/InitialService"));
         outProps.setAction(builder.newURI("http://org.jboss.ws/addressing/replyto/action"));

         EndpointReference eprReplyTo = builder.newEndpointReference(new URI("http://" + getServerHost() + ":8080/jbossws-addressing-replyto/ReplyToService"));
