/*
  ...
  */
package org.jboss.test.ws.anonymous;
...
public class AnonymousTypesTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(AnonymousTypesTestCase.class, "jbossws-anonymous.war, jbossws-anonymous-client.jar");
   }
