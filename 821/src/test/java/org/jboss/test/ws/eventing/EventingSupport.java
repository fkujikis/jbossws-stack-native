...
public class EventingSupport extends JBossWSTest
{
   ...
   protected DeliveryType getDefaultDelivery()
   {
      try
      {
         ...
         notifyEPR.setAddress(new URI("http://" + getServerHost() + ":8080/jbossws-test-eventing/eventSink"));
   ...
   {
      URL wsdlURL = new URL("http://" + getServerHost() + ":8080/jbossws-test-eventing/subscribe?wsdl");
