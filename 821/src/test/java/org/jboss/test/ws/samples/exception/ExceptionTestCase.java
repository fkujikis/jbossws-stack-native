 ...
 */
package org.jboss.test.ws.samples.exception;
...
public class ExceptionTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(ExceptionTestCase.class, "jbossws-samples-exception.war, jbossws-samples-exception-client.jar");
   }
   ...
   private ExceptionServiceInterface getPort() throws Exception
   {
      ...
      else
      {
         ...
         URL wsdlURL = new File("resources/samples/exception/WEB-INF/wsdl/ExceptionService.wsdl").toURL();
         URL mappingURL = new File("resources/samples/exception/WEB-INF/jaxrpc-mapping.xml").toURL();
         ...
         ((Stub)port)._setProperty(Stub.ENDPOINT_ADDRESS_PROPERTY, "http://" + getServerHost() + ":8080/jbossws-samples-exception");
         return port;
      }
   }
   ...
   public void testNonExistantOperation() throws Exception
   {
      ...
      String targetAddress = "http://" + getServerHost() + ":8080/jbossws-samples-exception/ExceptionBean";
