 ...
 */
package org.jboss.test.ws.samples.swa;
...
public class AttachmentProxyTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(AttachmentProxyTestCase.class, "jbossws-samples-swa.war, jbossws-samples-swa-client.jar");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (port == null)
      {
         ...
         else
         {
            ...
            URL wsdlURL = new File("resources/samples/swa/WEB-INF/wsdl/Attachment.wsdl").toURL();
            URL mappingURL = new File("resources/samples/swa/WEB-INF/jaxrpc-mapping.xml").toURL();
            QName qname = new QName("http://org.jboss.ws/samples/swa", "Attachment");
            Service service = factory.createService(wsdlURL, qname, mappingURL);
            port = (Attachment)service.getPort(Attachment.class);
            ((Stub)port)._setProperty(Stub.ENDPOINT_ADDRESS_PROPERTY, "http://" + getServerHost() + ":8080/jbossws-samples-swa");
         }
      }
   }
   ...
   {
      URL url = new File("resources/samples/swa/attach.gif").toURL();
   ...
   {
      URL url = new File("resources/samples/swa/attach.jpeg").toURL();
   ...
   {
      URL url = new File("resources/samples/swa/attach.txt").toURL();
   ...
   {
      FileInputStream stream = new FileInputStream("resources/samples/swa/attach.xml");
