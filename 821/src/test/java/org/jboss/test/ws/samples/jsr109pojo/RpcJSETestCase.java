...
public class RpcJSETestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(RpcJSETestCase.class, "jbossws-samples-jsr109pojo-rpc.war, jbossws-samples-jsr109pojo-rpc-client.jar");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (port == null)
      {
         ...
         else
         {
            ...
            URL wsdlURL = new File("resources/samples/jsr109pojo/rpclit//WEB-INF/wsdl/TestService.wsdl").toURL();
            URL mappingURL = new File("resources/samples/jsr109pojo/rpclit/WEB-INF/jaxrpc-mapping.xml").toURL();
            QName qname = new QName("http://org.jboss.ws/samples/jsr109pojo", "TestService");
            Service service = factory.createService(wsdlURL, qname, mappingURL);
            port = (JaxRpcTestService)service.getPort(JaxRpcTestService.class);
            ((Stub)port)._setProperty(Stub.ENDPOINT_ADDRESS_PROPERTY, "http://" + getServerHost() + ":8080/jbossws-samples-jsr109pojo-rpc");
         }
      }
   }
