 ...
 */
package org.jboss.test.ws.samples.wseventing;
...
public class SysmonTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(SysmonTestCase.class, "jbossws-samples-eventing.war, jbossws-samples-eventing-client.jar");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (subscriptionPort == null || managementPort == null)
      {
         ...
         else
         {
            ...
            URL wsdlURL = new File("resources/samples/wseventing/WEB-INF/wsdl/sysmon.wsdl").toURL();
            URL mappingURL = new File("resources/samples/wseventing/WEB-INF/jaxrpc-mapping.xml").toURL();
