 ...
 */
package org.jboss.test.ws.jbws956;
...
public class JBWS956TestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(JBWS956TestCase.class, "jbossws-jbws956.war");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (port == null)
      {
         ...
         URL wsdlURL = new File("resources/jbws956/WEB-INF/wsdl/TestService.wsdl").toURL();
         URL mappingURL = new File("resources/jbws956/WEB-INF/jaxrpc-mapping.xml").toURL();
