...
{
   private final String TARGET_ENDPOINT_ADDRESS = "http://" + getServerHost() + ":8080/jbossws-outparam";
   private static final String NAMESPACE_URI = "http://org.jboss.ws/outparam";

   public static Test suite()
   {
      return JBossWSTestSetup.newTestSetup(OutParamDIITestCase.class, "jbossws-outparam.war");
   }
