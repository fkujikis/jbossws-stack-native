...
public class JSR181ComplexTestCase extends JBossWSTest
{
   ...
   private RegistrationService getRegistrationService() throws MalformedURLException, ServiceException
   {
      ...
      RegistrationService registration = (RegistrationService) service.getPort(RegistrationService.class);
      return registration;
   }
