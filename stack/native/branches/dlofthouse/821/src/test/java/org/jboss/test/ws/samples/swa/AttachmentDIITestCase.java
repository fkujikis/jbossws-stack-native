...
{
   private final String TARGET_ENDPOINT_ADDRESS = "http://" + getServerHost() + ":8080/jbossws-samples-swa";
   ...
   {
      return JBossWSTestSetup.newTestSetup(AttachmentDIITestCase.class, "jbossws-samples-swa.war");
   }
   ...
   public void testSendMimeApplicationXML() throws Exception
   {
      ...
      URL url = new File("resources/samples/swa/attach.xml").toURL();
      sendAndValidateMimeMessage(call, new DataHandler(url));
   }
