/*
  ...
  */
package org.jboss.test.ws.overloaded;
...
public class OverloadedTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(OverloadedTestCase.class, "jbossws-overloaded.war, jbossws-overloaded-client.jar");
   }
