/*
  ...
  */
package org.jboss.test.ws.samples.jsr109ejb;
...
{
   private final String TARGET_ENDPOINT_ADDRESS = "http://" + getServerHost() + ":8080/jbossws-samples-jsr109ejb-rpc";
   ...
   {
      return JBossWSTestSetup.newTestSetup(RpcDIIConfiguredCallTestCase.class, "jbossws-samples-jsr109ejb-rpc.jar");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (call == null)
      {
         File javaWsdlMappingFile = new File("resources/samples/jsr109ejb/rpclit/META-INF/jaxrpc-mapping.xml");
