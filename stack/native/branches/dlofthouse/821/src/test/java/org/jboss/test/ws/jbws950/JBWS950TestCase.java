 ...
 */
package org.jboss.test.ws.jbws950;
...
public class JBWS950TestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(JBWS950TestCase.class, "jbossws-jbws950.war");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (port == null)
      {
         ...
         URL wsdlURL = new File("resources/jbws950/WEB-INF/wsdl/TestService.wsdl").toURL();
         URL mappingURL = new File("resources/jbws950/WEB-INF/jaxrpc-mapping.xml").toURL();
