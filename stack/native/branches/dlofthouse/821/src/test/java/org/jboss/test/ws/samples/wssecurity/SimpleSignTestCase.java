...
public class SimpleSignTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(SimpleSignTestCase.class, "jbossws-samples-wssecurity-sign.war, jbossws-samples-wssecurity-sign-client.jar");
   }
   ...
   private Hello getPort() throws Exception
   {
      ...
      else
      {
         ...
         URL securityURL = new File("resources/samples/wssecurity/simple-sign/META-INF/jboss-wsse-client.xml").toURL();
         ...
         Hello port = (Hello)service.getPort(Hello.class);
         ((Stub)port)._setProperty(Stub.ENDPOINT_ADDRESS_PROPERTY, "http://" + getServerHost() + ":8080/jbossws-samples-wssecurity-sign");
         return port;
      }
   }
}
