/*
  ...
  */
package org.jboss.test.ws.benchmark;
...
public class BenchmarkDocJSETestCase extends JBossWSTest
{
    ...
    {
        return JBossWSTestSetup.newTestSetup(BenchmarkDocJSETestCase.class, "benchmark-doclit.war, benchmark-doclit-client.jar");
    }
    ...
    {
        Order order = endpoint.getOrder(1,1);
