...
public class RpcDIIConfiguredCallTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(RpcDIIConfiguredCallTestCase.class, "jbossws-samples-jsr109pojo-rpc.war");
   }
   ...
   protected void setUp() throws Exception
   {
      ...
      if (call == null)
      {
         File javaWsdlMappingFile = new File("resources/samples/jsr109pojo/rpclit/WEB-INF/jaxrpc-mapping.xml");
