/*
  ...
  */
package org.jboss.test.ws.marshall;
...
{
   private final String TARGET_ADDRESS = "http://" + getServerHost() + ":8080/jbossws-marshall-rpclit";
   ...
   {
      return new JBossWSTestSetup(MarshallRpcLitDIITestCase.class, "jbossws-marshall-rpclit.war") {
