...
public class SimpleEncryptTestCase extends JBossWSTest
{
   ...
   {
      return JBossWSTestSetup.newTestSetup(SimpleEncryptTestCase.class, "jbossws-samples-wssecurity-encrypt.war, jbossws-samples-wssecurity-encrypt-client.jar");
   }
   ...
   private Hello getPort() throws Exception
   {
      ...
      else
      {
         ...
         URL securityURL = new File("resources/samples/wssecurity/simple-encrypt/META-INF/jboss-wsse-client.xml").toURL();
         ...
         Hello port = (Hello)service.getPort(Hello.class);
         ((Stub)port)._setProperty(Stub.ENDPOINT_ADDRESS_PROPERTY, "http://" + getServerHost() + ":8080/jbossws-samples-wssecurity-encrypt");
         return port;
      }
   }
}
